...
//   String studentID; // Student ID who is registering for the exam
//   String examID; // Exam ID for the exam being registered
//   DateTime registrationDate; // Date when the registration was made
//   DateTime examTime; // Date and time when the exam is scheduled
...
//                 decoration: InputDecoration(
//                   labelText: 'Exam Time',
//                   hintText: 'Enter exam time (e.g., 2023-11-15 09:00)',
//                   border: OutlineInputBorder(),
//                 ),
//                 validator: (value) {
//                   if (value == null || value.isEmpty) {
//                     return 'Please enter a valid exam time';
//                   }
//                   return null;
//                 },
//               ),
...
//                         content: Text(
//                             'Registration successful for exam ${registration.examID}.'),
//                         actions: [
//                           TextButton(
//                             onPressed: () {
